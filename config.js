...
global.ownername = process.env.OWNER_NAME === undefined ? "ᴾʳᵒ ᭄𝕐𝕌𝕁𝕀 𝕀𝕋𝔸𝔻𝕆ℝ𝕀么" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '265990169520' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'Well❤️‍🩹✨️' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'ᴾʳᵒ ᭄𝕐𝕌𝕁𝕀 𝕀𝕋𝔸𝔻𝕆ℝ𝕀么' : process.env.STICKER_AUTHOR_NAME
